...
class Product(models.Model):
    ...
    product_image = models.ImageField(db_column='product_image', upload_to='products/', blank=True, null=True)  # Field name made lowercase.
...
class Orders(models.Model):
    ...
    payment_status = models.CharField(db_column='payment_status', max_length=20, default='Chờ thanh toán')
